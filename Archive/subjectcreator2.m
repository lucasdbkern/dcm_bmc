function subjectcreator2(dcm_file_path, model_type, noise_magnitude_Ep, noise_magnitude_u, noise_magnitude_erp, Nm, customA1, customA2, customA3, param_key)
%==========================================================================
...
while i <= Nm
    ...
    %L = spm_lx_erp(DCM.Eg,DCM.M.dipfit);
