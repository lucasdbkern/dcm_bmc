function assign_timeseries()
    ...
    group_path = '/Users/lucaskern/Desktop/Desktop/UCL/Research_Project/github/results/group/';
    save(fullfile(group_path, 'DCM_Original.mat'), 'DCM_Original');
    save(fullfile(group_path, 'DCM_ORA.mat'), 'DCM_ORA');
    save(fullfile(group_path, 'DCM_TRA.mat'), 'DCM_TRA');
end
